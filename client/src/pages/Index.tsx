...
const Index = () => {
  ...
  return (
    <AnimationContext.Provider value={{ animationsEnabled }}>
      ...
      >
        <source
          src="https://res.cloudinary.com/dhizc6kfs/video/upload/v1759767574/ytmp3free.cc_cant-help-falling-in-love-elvis-presley-violin-cover-youtubemp3free.org_fuehgf.mp3"
          type="audio/mpeg"
        />
