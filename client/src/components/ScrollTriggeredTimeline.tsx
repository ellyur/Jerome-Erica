...
const TimelineCard: React.FC<TimelineCardProps> = ({ timelineEvent, i }) => {
    ...
    const getEventDescription = (eventName: string): string => {
        const descriptions: Record<string, string> = {
            "ASSEMBLY": "Join us as we gather to celebrate our special day. Please arrive on time.",
            "CEREMONY": "Witness our vows and the beginning of our journey together as we exchange rings and promises.",
            "PHOTOS": "Capture beautiful moments with our loved ones and the newlyweds.",
            "RECEPTION": "Join us for the celebration as we welcome you to the reception.",
            "DINNER": "Enjoy a delicious meal followed by touching speeches from our closest family and friends.",
