  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mb-8" data-testid="text-rsvp-title">
            Please RSVP
          </h2>
        </motion.div>
        ...
        >
          <div className="bg-card/30 border border-border rounded-xl p-12 shadow-soft hover-elegant">
            ...
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-2 text-foreground">RSVP Deadline</h3>
              <p className="text-xl sm:text-2xl font-semibold text-foreground">October 30, 2025</p>
            </div>
